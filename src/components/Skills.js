    ...
    <div className="py-16" id="skills">
      <div className="row">
        ...
        <div className="flex justify-between items-center flex-wrap">
          <div data-aos="fade-down" className="skill" style={{ width: "45%" }}>
            {skill.map((single, index) => {
              return (
                <div className="progress__bar mb-3 font-medium" key={index}>
                  <h3 className="progress__name mb-1">{single.title}</h3>
